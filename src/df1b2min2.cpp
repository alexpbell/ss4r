...
void ad_read_pass2_minuscv(void);
 ...
 int df1b2_gradlist::write_pass1_minuscv(const df1b2variable * _py,
   df1b2variable * pz)
 {
...
// end of string identifier debug stuff
   ...
   nlist.bptr->pf=(ADrfptr)(&ad_read_pass2_minuscv);
      ++nlist;
   return 0;
 }
...
void ad_read_pass2_minuscv(void)
{
  ...
  {
  case 1:
    read_pass2_1_minuscv();
    break;
  case 2:
    read_pass2_2_minuscv();
    break;
  case 3:
...
void read_pass2_1_minuscv(void)
{
  ...
  // get info from tape1
#if defined(SAFE_ALL)
  checkidentiferstring("GU",f1b2gradlist->list);
#endif
