...
void ad_read_pass2_minusvc(void);
 ...
 int df1b2_gradlist::write_pass1_minusvc(const df1b2variable * _py,
   df1b2variable * pz)
 {
...
// end of string identifier debug stuff
   ...
   nlist.bptr->pf=(ADrfptr)(&ad_read_pass2_minusvc);
      ++nlist;
   return 0;
 }
...
void ad_read_pass2_minusvc(void)
{
  ...
  {
  case 1:
    read_pass2_1_minusvc();
    break;
  case 2:
    read_pass2_2_minusvc();
    break;
  case 3:
...
void read_pass2_1_minusvc(void)
{
  ...
  // get info from tape1
#if defined(SAFE_ALL)
  checkidentiferstring("LK",f1b2gradlist->list);
#endif
