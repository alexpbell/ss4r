 ...
 * \param
 */
void* vector_shape::operator new([[maybe_unused]] size_t n)
{
#if defined(DEBUG)
 ...
 * \param
 */
void* arr_link::operator new([[maybe_unused]] size_t n)
{
#if defined(DEBUG)
  if (xpool && xpool->size != n)
  {
 ...
 * \param
 */
void* vector_shapex::operator new([[maybe_unused]] size_t n)
{
#if defined(DEBUG)
  if (xpool && xpool->size != n)
  {
