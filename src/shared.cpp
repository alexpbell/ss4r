...
#  if defined(USE_SHARE_FLAGS)
  ...
  void initial_params::shared_set_value([[maybe_unused]] const dvar_vector& x,
    [[maybe_unused]] const int& ii, [[maybe_unused]] const dvariable& pen)
  {
  ...
  void initial_params::shared_set_value_inv([[maybe_unused]] const dvector& x, [[maybe_unused]] const int& ii)
  {
    cerr << " Error -- shared_scaled_set_value_inv not defined for this class"
         << endl;
    ad_exit(1);
  ...
  void param_init_matrix::shared_set_value(const dvar_vector& _x,
    const int& _ii, [[maybe_unused]] const dvariable& pen)
  {
    ADUNCONST(int,ii)
  ...
  void initial_params::setshare([[maybe_unused]] const index_type& sf,
    [[maybe_unused]] const index_type& af)
  {
