...
double do_interpolate(const double& _fret, const double& _left_bracket,
  ...
  dvector& right_bracket_gradient, [[maybe_unused]] const dvector& theta, const dvector& d,
  const int& _J, [[maybe_unused]] long int& ifn, const double& crit1,
...
void do_extrapolate(const double& _left_bracket,
  ...
  const dvector& _right_bracket_gradient, [[maybe_unused]] const dvector& theta,
  dvector& d, const int& _J, const double& rho_0, [[maybe_unused]] long int& ifn,
